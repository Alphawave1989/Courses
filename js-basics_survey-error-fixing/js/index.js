...
const nextButton = document.querySelector('[data-js="next-button"]'); // Use a descriptive data attribute
...
firstChoiceButton.addEventListener("click", () => {
  ...
  console.log("Selected first choice"); // Use "console.log"
});
...
secondChoiceButton.addEventListener("click", () => {
  ...
  console.log("Selected second choice"); // Add "active-choice"
});
